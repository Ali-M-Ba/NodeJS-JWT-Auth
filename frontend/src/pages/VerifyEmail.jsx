    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-red-300">
      <div className="w-full max-w-md bg-amber-300 border-4 border-black shadow-[6px_6px_0_#000] p-6 rounded-lg">
        <form onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className="mt-4 rounded-lg bg-green-500 border-2 shadow-[4px_4px_0_#000] px-4 py-2 font-bold hover:translate-x-0.5 hover:translate-y-0.5 hover:shadow-[2px_2px_0_#000] transition-transform"
          >
            Verify Account
          </button>
        </form>
