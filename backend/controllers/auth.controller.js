...
export const getUserInfo = (req, res) => {
  ...
  if (token) {
    ...
    handleSuccessRes(res, 200, "User fetched succussfully.", user);
  } else {
    handleFailedRes(res, { status: 404, message: "User not logged in." });
  }
};
...
export const processSignup = async (req, res) => {
  ...
  try {
    ...
    const payload = {
      ...
      isVerified: savedUser.isAccountVerified,
    };
    ...
    handleSuccessRes(res, 201, "Signed up successfully", payload);
  } catch (error) {
...
export const processLogin = async (req, res) => {
  ...
  try {
    ...
    handleSuccessRes(res, 200, "Logged in successfully", payload);
  } catch (error) {
